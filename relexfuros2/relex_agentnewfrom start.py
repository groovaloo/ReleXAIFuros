...
# 🔁 ATIVAR OU DESATIVAR TAVILY AQUI:
usar_tavily = True
...
if usar_tavily:
    ...
    tools.append(
        Tool(
            name="TavilySearch",
            func=lambda q: search.run(q, filters={"site": [
                "apambiente.pt",
                "dre.pt",
                "snirh.apambiente.pt",
                "participa.pt",
            ...
            description="Usa pesquisa online para encontrar informação legal ou técnica nos sites oficiais do Estado português."
        )
    )
